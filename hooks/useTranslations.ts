...
import { createContext, useState, useContext, useEffect, useCallback, createElement } from 'react';
...
export const TranslationProvider = ({ children }: TranslationProviderProps) => {
    ...
    return createElement(TranslationContext.Provider, { value: { lang, dir, t, setLang } }, children);
};
