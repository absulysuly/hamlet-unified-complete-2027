...
import { inclusiveFeaturesList, events, format } from '@/lib/constants';
import type { Event } from '@/types';
import { useTranslations } from '@/hooks/useTranslations';
import { Check, X, MapPin, Clock } from '@/components/icons';
...
const ColorContrastChecker = () => {
    ...
    const ComplianceRow = ({ label, aa, aaa }: ComplianceRowProps) => (
...
const VisualAccessibilitySettings = ({ highContrast, setHighContrast }: InclusiveFeaturesProps) => {
    const { t } = useTranslations();
    return (
...
export const InclusiveFeatures = ({ highContrast, setHighContrast }: InclusiveFeaturesProps) => {
