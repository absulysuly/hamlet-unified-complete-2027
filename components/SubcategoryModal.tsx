...
import { X, ChevronDown, Grid3x3 } from '@/components/icons';
...
const AccordionItem = ({ group, category, onSubcategorySelect }: AccordionItemProps) => {
...
export const SubcategoryModal = ({ category, onClose, onSubcategorySelect }: SubcategoryModalProps) => {
