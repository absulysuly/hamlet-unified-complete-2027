...
import { businesses, categories } from '@/lib/constants';
import type { Business } from '@/types';
import { Star, Grid3x3, List, MapPin, CheckCircle, ArrowLeft } from '@/components/icons';
...
const BusinessCard = ({ business, viewMode }: BusinessCardProps) => {
...
export const BusinessDirectory = ({ initialFilter, onBack }: BusinessDirectoryProps) => {
