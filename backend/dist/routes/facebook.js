...
const facebookService_1 = __importDefault(require("../services/facebookService"));
const router = express_1.default.Router();
let facebookService;
try {
    facebookService = new facebookService_1.default();
}
catch (error) {
...
router.get('/facebook/pages/:pageId/posts', async (req, res) => {
    try {
        ...
        const pageData = await facebookService.getPagePosts(pageId, parseInt(limit));
        if (format === 'standard') {
